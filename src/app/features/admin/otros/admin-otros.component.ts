    ...
    <div class="p-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <a
          ...
          class="bg-white rounded-2xl border border-slate-200 p-6 hover:border-purple-300 hover:shadow-md transition cursor-pointer block"
        >
        ...
        <a
          ...
          class="bg-white rounded-2xl border border-slate-200 p-6 hover:border-orange-300 hover:shadow-md transition cursor-pointer block"
        >
        ...
        <!-- Estilos de Vida -->
        <a
          routerLink="/admin/estilos-vida"
          class="bg-white rounded-2xl border border-slate-200 p-6 hover:border-teal-300 hover:shadow-md transition cursor-pointer block"
        >
          <div class="w-12 h-12 mb-4 rounded-xl bg-teal-100 flex items-center justify-center">
            <svg class="w-6 h-6 text-teal-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
            </svg>
          </div>
          <h3 class="font-semibold text-slate-900 mb-1">Estilos de Vida</h3>
          <p class="text-sm text-slate-500">CRUD para historia clínica</p>
        </a>
      </div>
